import { z as useSkin, j as jsx, F as Fragment, x as jsxs, W as useNavigate } from "./index.18b6d573.js";
import { B as BreadCrumbs, w as Row, x as Col, y as Card } from "./App.dfab3394.js";
import { C as Container } from "./Container.dd96083c.js";
const PictureToVideoSvg = () => {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: skin === "light" ? /* @__PURE__ */ jsxs("svg", { width: "66", height: "68", viewBox: "0 0 66 68", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [
    ...
    /* @__PURE__ */ jsx("rect", { x: "17", y: "19", width: "32", height: "31", rx: "6", fill: "url(#paint0_linear_1141_112953)" }),
    /* @__PURE__ */ jsx("path", { d: "M41 34.503V29C41 28.7348 40.8946 28.4804 40.7071 28.2929C40.5196 28.1054 40.2652 28 40 28H26C25.7348 28 25.4804 28.1054 25.2929 28.2929C25.1054 28.4804 25 28.7348 25 29V39C25 39.2652 25.1054 39.5196 25.2929 39.7071C25.4804 39.8946 25.7348 40 26 40H29.504L33.894 32.678C34.1283 32.2874 34.4484 31.9553 34.8302 31.7069C35.2119 31.4584 35.6452 31.3002 36.0972 31.2441C36.5492 31.188 37.008 31.2356 37.4389 31.3832C37.8697 31.5308 38.2613 31.7745 38.584 32.096L41 34.503ZM41 37.326L37.172 33.512C37.0644 33.405 36.9338 33.3238 36.7902 33.2747C36.6465 33.2256 36.4936 33.2099 36.343 33.2287C36.1924 33.2475 36.048 33.3003 35.9208 33.3832C35.7937 33.4661 35.687 33.5768 35.609 33.707L31.836 40H40C40.2652 40 40.5196 39.8946 40.7071 39.7071C40.8946 39.5196 41 39.2652 41 39V37.326ZM26 26H40C40.7956 26 41.5587 26.3161 42.1213 26.8787C42.6839 27.4413 43 28.2044 43 29V39C43 39.7956 42.6839 40.5587 42.1213 41.1213C41.5587 41.6839 40.7956 42 40 42H26C25.2044 42 24.4413 41.6839 23.8787 41.1213C23.3161 40.5587 23 39.7956 23 39V29C23 28.2044 23.3161 27.4413 23.8787 26.8787C24.4413 26.3161 25.2044 26 26 26ZM29 35C28.2044 35 27.4413 34.6839 26.8787 34.1213C26.3161 33.5587 26 32.7956 26 32C26 31.2044 26.3161 30.4413 26.8787 29.8787C27.4413 29.3161 28.2044 29 29 29C29.7956 29 30.5587 29.3161 31.1213 29.8787C31.6839 30.4413 32 31.2044 32 32C32 32.7956 31.6839 33.5587 31.1213 34.1213C30.5587 34.6839 29.7956 35 29 35ZM29 33C29.2652 33 29.5196 32.8946 29.7071 32.7071C29.8946 32.5196 30 32.2652 30 32C30 31.7348 29.8946 31.4804 29.7071 31.2929C29.5196 31.1054 29.2652 31 29 31C28.7348 31 28.4804 31.1054 28.2929 31.2929C28.1054 31.4804 28 31.7348 28 32C28 32.2652 28.1054 32.5196 28.2929 32.7071C28.4804 32.8946 28.7348 33 29 33Z", fill: "white" }),
    /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("linearGradient", { id: "paint0_linear_1141_112953", x1: "4.0359", y1: "34.5", x2: "49", y2: "34.5", gradientUnits: "userSpaceOnUse", children: [
    ...
    /* @__PURE__ */ jsx("rect", { x: "17", y: "19", width: "32", height: "31", rx: "6", fill: "url(#paint0_linear_1744_112964)" }),
    /* @__PURE__ */ jsx("path", { d: "M41 34.503V29C41 28.7348 40.8946 28.4804 40.7071 28.2929C40.5196 28.1054 40.2652 28 40 28H26C25.7348 28 25.4804 28.1054 25.2929 28.2929C25.1054 28.4804 25 28.7348 25 29V39C25 39.2652 25.1054 39.5196 25.2929 39.7071C25.4804 39.8946 25.7348 40 26 40H29.504L33.894 32.678C34.1283 32.2874 34.4484 31.9553 34.8302 31.7069C35.2119 31.4584 35.6452 31.3002 36.0972 31.2441C36.5492 31.188 37.008 31.2356 37.4389 31.3832C37.8697 31.5308 38.2613 31.7745 38.584 32.096L41 34.503ZM41 37.326L37.172 33.512C37.0644 33.405 36.9338 33.3238 36.7902 33.2747C36.6465 33.2256 36.4936 33.2099 36.343 33.2287C36.1924 33.2475 36.048 33.3003 35.9208 33.3832C35.7937 33.4661 35.687 33.5768 35.609 33.707L31.836 40H40C40.2652 40 40.5196 39.8946 40.7071 39.7071C40.8946 39.5196 41 39.2652 41 39V37.326ZM26 26H40C40.7956 26 41.5587 26.3161 42.1213 26.8787C42.6839 27.4413 43 28.2044 43 29V39C43 39.7956 42.6839 40.5587 42.1213 41.1213C41.5587 41.6839 40.7956 42 40 42H26C25.2044 42 24.4413 41.6839 23.8787 41.1213C23.3161 40.5587 23 39.7956 23 39V29C23 28.2044 23.3161 27.4413 23.8787 26.8787C24.4413 26.3161 25.2044 26 26 26ZM29 35C28.2044 35 27.4413 34.6839 26.8787 34.1213C26.3161 33.5587 26 32.7956 26 32C26 31.2044 26.3161 30.4413 26.8787 29.8787C27.4413 29.3161 28.2044 29 29 29C29.7956 29 30.5587 29.3161 31.1213 29.8787C31.6839 30.4413 32 31.2044 32 32C32 32.7956 31.6839 33.5587 31.1213 34.1213C30.5587 34.6839 29.7956 35 29 35ZM29 33C29.2652 33 29.5196 32.8946 29.7071 32.7071C29.8946 32.5196 30 32.2652 30 32C30 31.7348 29.8946 31.4804 29.7071 31.2929C29.5196 31.1054 29.2652 31 29 31C28.7348 31 28.4804 31.1054 28.2929 31.2929C28.1054 31.4804 28 31.7348 28 32C28 32.2652 28.1054 32.5196 28.2929 32.7071C28.4804 32.8946 28.7348 33 29 33Z", fill: "white" }),
    /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("linearGradient", { id: "paint0_linear_1744_112964", x1: "4.0359", y1: "34.5", x2: "49", y2: "34.5", gradientUnits: "userSpaceOnUse", children: [
      /* @__PURE__ */ jsx("stop", { stopColor: "#1970D7" }),
      /* @__PURE__ */ jsx("stop", { offset: "1", stopColor: "#177FFA" })
    ] }) })
  ] }) });
...
const Gallery = () => {
  ...
  return /* @__PURE__ */ jsxs(Container, { className: "parent-card-2 dark-theme-parent-card-2", children: [
    /* @__PURE__ */ jsxs("div", { className: "breadCrumb-custom dark-breadCrumb-custom", children: [
      ...
      /* @__PURE__ */ jsx(BreadCrumbs, { title: "Gallery", data: [{ title: "Create Video", link: "/create-video" }, { title: "Gallery", link: "/video-gallery" }] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "component", children: /* @__PURE__ */ jsxs(Row, { lg: 12, children: [
      /* @__PURE__ */ jsx(Col, { lg: 4, children: /* @__PURE__ */ jsx("div", { className: "child-card dark-theme-child-card", children: /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(Row, { children: /* @__PURE__ */ jsxs(Col, { className: "mt-2", children: [
              ...
              /* @__PURE__ */ jsx(Card.Subtitle, { className: "text-muted", children: "Your generated own video with picture and script or audio." })
            ] }) })
          ]
        }
      ) }) }),
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(Row, { children: /* @__PURE__ */ jsxs(Col, { className: "mt-2", children: [
              ...
              /* @__PURE__ */ jsx(Card.Subtitle, { className: "text-muted", children: "Your created unique animated videos for Social media using text." })
            ] }) })
          ]
        }
      ) }) }),
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(Row, { children: /* @__PURE__ */ jsxs(Col, { className: "mt-2", children: [
              ...
              /* @__PURE__ */ jsx(Card.Subtitle, { className: "text-muted", children: "Your generated viral & unique short videos." })
            ] }) })
          ]
        }
      ) }) })
