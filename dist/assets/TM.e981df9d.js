...
const TM = () => {
  ...
  return /* @__PURE__ */ jsxs(Container, { className: "parent-card-2 dark-theme-parent-card-2 dark-theme-parent-card-2", children: [
    /* @__PURE__ */ jsxs("div", { className: "breadCrumb-custom dark-breadCrumb-custom", children: [
      /* @__PURE__ */ jsx(TMSvg, {}),
      /* @__PURE__ */ jsx(BreadCrumbs, { title: "Twitter Machine", data: [{ title: "Creation Hub", link: "/creationhub" }, { title: "Twitter", link: "/twitter" }, { title: "Twitter Machine", link: "/twitter_machine" }] })
    ] }),
    ...
    /* @__PURE__ */ jsx(Container, { className: "inner-parent-child dark-theme-inner-parent-child", children: /* @__PURE__ */ jsxs(Row, { className: "h-100", children: [
      /* @__PURE__ */ jsx(Col, { lg: "6", className: "h-100", children: /* @__PURE__ */ jsxs("div", { className: "h-100 custom-card-5 dark-theme-custom-card-5", children: [
        /* @__PURE__ */ jsxs(Card.Body, { children: [
          /* @__PURE__ */ jsx(Card.Title, { children: "Tweet Machine" }),
          /* @__PURE__ */ jsx(Card.Text, { children: "Generate viral tweets for Twitter." })
        ] }),
        /* @__PURE__ */ jsx(Card.Body, { children: /* @__PURE__ */ jsxs("form", { className: "mt-5", onSubmit: (e) => handleSubmit(e), children: [
          /* @__PURE__ */ jsxs("div", { className: "form-group", children: [
            /* @__PURE__ */ jsx("label", { children: "What is your tweet about?" }),
