import { r as react, z as useSkin, W as useNavigate, Z as useLocation, x as jsxs, j as jsx, B as Button, U as Link } from "./index.b27a7f54.js";
import { c as create, a as create$1, q as create$2, u as useFormik, C as Card, r as Col, b as CardBody, d as Clatterdark, e as ClatterLogo, L as Label, I as Input, h as FormFeedback, i as InputPasswordToggle, s as dist, j as authPosterForDarkLayout, k as ImgeLogo, A as AuthApi } from "./App.beb1f410.js";
import { G as GoggleWithLogin } from "./GoggleWithLogin.71a876c7.js";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "register-maim-dev register-page", children: [
    /* @__PURE__ */ jsx(Card, { className: "register-card m-0", children: /* @__PURE__ */ jsxs(Col, { xs: "10", sm: "10", md: "10", lg: "10", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "auth-register-form mt-2", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "divider my-1", children: [
          /* @__PURE__ */ jsx("div", { className: "divider-text", children: "or" }),
          /* @__PURE__ */ jsx("div", { className: "auth-footer-btn d-flex justify-content-center", children: /* @__PURE__ */ jsx(GoggleWithLogin, { buttonText: "Sign up with Google" }) })
        ] })
      ] })
    ] }) }),
