import { L as useDispatch, N as useSelector, r as react, P as subscriptionActions, aP as emptyPostSuggestion, x as jsxs, j as jsx, aR as Loader, aQ as postSuggestions } from "./index.b27a7f54.js";
...
const YS = () => {
  ...
  return /* @__PURE__ */ jsxs(Container, { className: "parent-card-2 dark-theme-parent-card-2 dark-theme-parent-card-2", children: [
    /* @__PURE__ */ jsxs("div", { className: "breadCrumb-custom dark-breadCrumb-custom", children: [
      /* @__PURE__ */ jsx(YSSvg, {}),
      /* @__PURE__ */ jsx(BreadCrumbs, { title: "Youtube Video Script", data: [{ title: "Creation Hub", link: "/creationhub" }, { title: "Youtube", link: "/youtube" }, { title: "Youtube Script", link: "/youtube_script" }] })
    ] }),
    /* @__PURE__ */ jsx(Modal, { show, onHide: handleClose, children: /* @__PURE__ */ jsx(Modal.Body, { children: msgRef.current }) }),
    /* @__PURE__ */ jsxs(Container, { className: "inner-parent-child", children: [
      /* @__PURE__ */ jsx("div", { className: "spinner" }),
      /* @__PURE__ */ jsxs(Row, { className: "h-100", children: [
        /* @__PURE__ */ jsx(Col, { lg: "6", className: "h-100 ", children: /* @__PURE__ */ jsxs("div", { className: "h-100 custom-card-5 dark-theme-custom-card-5", children: [
          /* @__PURE__ */ jsxs(Card.Body, { children: [
            /* @__PURE__ */ jsx(Card.Title, { children: "Youtube Video Script" }),
            /* @__PURE__ */ jsx(Card.Text, { children: "Create youtube script for your videos." })
          ] }),
          /* @__PURE__ */ jsx(Card.Body, { className: "", children: /* @__PURE__ */ jsxs("form", { className: "mt-5", onSubmit: (e) => handleSubmit(e), children: [
